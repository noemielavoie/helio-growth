title: "HCO3 wild type growth curves"
date: "2021-06-18"
output: github_document 
---


Here follows script and figures for the analysis of growth curve data from 2021_03_31 where I grew wild type H. modesticaldum mutant phototrophically in  medium PYE + 20uM FeSO4 under different NaHCO3- treatments. No HCO3-, 1mM and 20mM. Biological triplicates were used for each treatment.
...
HCO3_wildtype <- read_excel("2021_06_16_wildtype_HCO3.xlsx")
##Make your first graph for fun
ggplot(data = HCO3_wildtype, aes(x = hours, y = OD, colour = treatment, shape = as.factor(biol_rep_number))) +
  geom_point()
```
